...
ASGNP4
line 2043
;2041:	// some movers spawn on the second frame, so delay item
;2042:	// spawns until the third frame so they can ride trains
;2043:	ent->nextthink = level.time + FRAMETIME * 2;
ADDRFP4 0
INDIRP4
CNSTI4 632
ADDP4
...
ASGNI4
line 2044
;2044:	ent->think = FinishSpawningItem;
ADDRFP4 0
INDIRP4
CNSTI4 636
ADDP4
...
line 2046
;2045:
;2046:	ent->physicsBounce = 0.50;		// items are bouncy
ADDRFP4 0
INDIRP4
CNSTI4 504
ADDP4
...
line 2048
;2047:
;2048:	if ( item->giType == IT_POWERUP ) {
ADDRFP4 4
INDIRP4
CNSTI4 36
ADDP4
...
NEI4 $736
line 2049
;2049:		G_SoundIndex( "sound/items/respawn1" );
ADDRGP4 $518
ARGP4
ADDRGP4 G_SoundIndex
CALLI4
pop
line 2050
;2050:		G_SpawnFloat( "noglobalsound", "0", &ent->speed);
ADDRGP4 $738
ARGP4
ADDRGP4 $721
ARGP4
...
;2059:================
;2060:*/
;2061:void G_BounceItem( gentity_t *ent, trace_t *trace ) {
line 2067
;2062:	vec3_t	velocity;
;2063:	float	dot;
;2064:	int		hitTime;
;2065:
;2066:	// reflect the velocity on the trace plane
;2067:	hitTime = level.previousTime + ( level.time - level.previousTime ) * trace->fraction;
ADDRLP4 16
ADDRGP4 level+36
INDIRI4
CVIF4 4
...
ASGNI4
line 2068
;2068:	BG_EvaluateTrajectoryDelta( &ent->s.pos, hitTime, velocity );
ADDRFP4 0
INDIRP4
CNSTI4 12
ADDP4
...
pop
line 2069
;2069:	dot = DotProduct( velocity, trace->plane.normal );
ADDRLP4 20
ADDRFP4 4
INDIRP4
ASGNP4
...
ASGNF4
line 2070
;2070:	VectorMA( velocity, -2*dot, trace->plane.normal, ent->s.pos.trDelta );
ADDRFP4 0
INDIRP4
CNSTI4 36
ADDP4
...
line 2073
;2071:
;2072:	// cut the velocity to keep from bouncing forever
;2073:	VectorScale( ent->s.pos.trDelta, ent->physicsBounce, ent->s.pos.trDelta );
ADDRLP4 24
ADDRFP4 0
INDIRP4
ASGNP4
...
line 2075
;2074:
;2075:	if ((ent->s.weapon == WP_DET_PACK && ent->s.eType == ET_GENERAL && ent->physicsObject))
ADDRLP4 48
ADDRFP4 0
INDIRP4
ASGNP4
...
;2078:		{
line 2079
;2079:			ent->touch(ent, &g_entities[trace->entityNum], trace);
ADDRLP4 56
ADDRFP4 0
INDIRP4
ASGNP4
...
;2083:
;2084:	// check for stop
;2085:	if ( trace->plane.normal[2] > 0 && ent->s.pos.trDelta[2] < 40 ) {
ADDRFP4 4
INDIRP4
CNSTI4 32
ADDP4
...
GEF4 $751
line 2086
;2086:		trace->endpos[2] += 1.0;	// make sure it is off ground
ADDRLP4 56
ADDRFP4 4
INDIRP4
CNSTI4 20
...
ASGNF4
line 2088
;2088:		G_SetOrigin( ent, trace->endpos );
ADDRFP4 0
INDIRP4
ARGP4
ADDRFP4 4
...
pop
line 2089
;2089:		ent->s.groundEntityNum = trace->entityNum;
ADDRFP4 0
INDIRP4
CNSTI4 192
ADDP4
...
;2091:	}
;2092:
;2093:	VectorAdd( ent->r.currentOrigin, trace->plane.normal, ent->r.currentOrigin);
ADDRLP4 56
ADDRFP4 0
INDIRP4
CNSTI4 368
...
ASGNF4
line 2094
;2094:	VectorCopy( ent->r.currentOrigin, ent->s.pos.trBase );
ADDRLP4 68
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNB 12
line 2095
;2095:	ent->s.pos.trTime = level.time;
ADDRFP4 0
INDIRP4
CNSTI4 16
ADDP4
...
line 2097
;2096:
;2097:	if (ent->s.eType == ET_HOLOCRON ||
ADDRLP4 72
ADDRFP4 0
INDIRP4
ASGNP4
...
LABELV $756
line 2099
;2098:		(ent->s.shouldtarget && ent->s.eType == ET_GENERAL && ent->physicsObject))
;2099:	{ //holocrons and sentry guns
line 2100
;2100:		if (ent->touch)
ADDRFP4 0
INDIRP4
...
;2101:		{
line 2102
;2102:			ent->touch(ent, &g_entities[trace->entityNum], trace);
ADDRLP4 84
ADDRFP4 0
INDIRP4
ASGNP4
...
;2112:================
;2113:*/
;2114:void G_RunItem( gentity_t *ent ) {
line 2121
;2115:	vec3_t		origin;
;2116:	trace_t		tr;
;2117:	int			contents;
;2118:	int			mask;
;2119:
;2120:	// if groundentity has been set to -1, it may have been pushed off an edge
;2121:	if ( ent->s.groundEntityNum == -1 ) {
ADDRFP4 0
INDIRP4
CNSTI4 192
ADDP4
...
NEI4 $760
line 2122
;2122:		if ( ent->s.pos.trType != TR_GRAVITY ) {
ADDRFP4 0
INDIRP4
CNSTI4 12
ADDP4
...
EQI4 $762
line 2123
;2123:			ent->s.pos.trType = TR_GRAVITY;
ADDRFP4 0
INDIRP4
CNSTI4 12
ADDP4
...
ASGNI4
line 2124
;2124:			ent->s.pos.trTime = level.time;
ADDRFP4 0
INDIRP4
CNSTI4 16
ADDP4
...
line 2128
;2127:
;2128:	if ( ent->s.pos.trType == TR_STATIONARY ) {
ADDRFP4 0
INDIRP4
CNSTI4 12
ADDP4
...
;2132:	}
;2133:
;2134:	// get current position
;2135:	BG_EvaluateTrajectory( &ent->s.pos, level.time, origin );
ADDRFP4 0
INDIRP4
CNSTI4 12
ADDP4
...
line 2138
;2136:
;2137:	// trace a line from the previous position to the current position
;2138:	if ( ent->clipmask ) {
ADDRFP4 0
INDIRP4
CNSTI4 508
ADDP4
...
LABELV $768
line 2141
;2141:		mask = MASK_PLAYERSOLID & ~CONTENTS_BODY;//MASK_SOLID;
ADDRLP4 1096
CNSTI4 17
ASGNI4
line 2142
...
LABELV $769
line 2143
;2143:	trap_Trace( &tr, ent->r.currentOrigin, ent->r.mins, ent->r.maxs, origin, 
ADDRLP4 0
ARGP4
ADDRLP4 1100
ADDRFP4 0
...
pop
line 2146
;2144:		ent->r.ownerNum, mask );
;2145:
;2146:	VectorCopy( tr.endpos, ent->r.currentOrigin );
ADDRFP4 0
INDIRP4
CNSTI4 368
ADDP4
...
line 2152
;2151:
;2152:	trap_LinkEntity( ent );	// FIXME: avoid this for stationary?
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 trap_LinkEntity
...
;2159:	}
;2160:
;2161:	// if it is in a nodrop volume, remove it
;2162:	contents = trap_PointContents( ent->r.currentOrigin, -1 );
ADDRFP4 0
INDIRP4
CNSTI4 368
ADDP4
...
ASGNI4
line 2163
;2163:	if ( contents & CONTENTS_NODROP ) {
ADDRLP4 1092
INDIRI4
CNSTI4 2048
BANDI4
...
EQI4 $778
line 2164
;2164:		if (ent->item && ent->item->giType == IT_TEAM) {
ADDRLP4 1108
ADDRFP4 0
INDIRP4
CNSTI4 824
