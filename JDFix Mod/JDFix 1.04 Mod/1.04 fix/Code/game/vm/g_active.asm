...
;1094:		{
line 1096
;1095:			//JediDog: Added Freeze
;1096:			if (client->freeze==1)
ADDRLP4 4
INDIRP4
CNSTI4 1804
ADDP4
...
;1097:			{
line 1098
;1098:				if (client->pers.cmd.forwardmove || client->pers.cmd.rightmove || client->pers.cmd.upmove) {
ADDRLP4 424
CNSTI4 0
ASGNI4
ADDRLP4 4
...
LABELV $499
line 1099
;1099:					client->ps.saberCanThrow = qtrue;
ADDRLP4 4
INDIRP4
CNSTI4 560
ADDP4
...
ASGNI4
line 1100
;1100:					client->ps.pm_type = PM_NORMAL;
ADDRLP4 4
INDIRP4
CNSTI4 4
ADDP4
...
LABELV $496
line 1103
;1103:					client->ps.pm_type = PM_FREEZE;
ADDRLP4 4
INDIRP4
CNSTI4 4
ADDP4
...
;1107:			{
line 1108
;1108:				client->ps.pm_type = PM_NORMAL;
ADDRLP4 4
INDIRP4
CNSTI4 4
ADDP4
...
line 1113
;1112:
;1113:	client->ps.gravity = g_gravity.value;
ADDRLP4 4
INDIRP4
CNSTI4 56
ADDP4
...
;1114:
;1115:	// set speed
;1116:	client->ps.speed = g_speed.value;
ADDRLP4 4
INDIRP4
CNSTI4 60
ADDP4
...
ASGNI4
line 1117
;1117:	client->ps.basespeed = g_speed.value;
ADDRLP4 4
INDIRP4
CNSTI4 64
ADDP4
...
line 1119
;1118:
;1119:	if (ent->client->ps.duelInProgress)
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
;1120:	{
line 1121
;1121:		gentity_t *duelAgainst = &g_entities[ent->client->ps.duelIndex];
ADDRLP4 420
CNSTI4 832
ADDRFP4 0
INDIRP4
...
line 1127
;1122:
;1123:		//Keep the time updated, so once this duel ends this player can't engage in a duel for another
;1124:		//10 seconds. This will give other people a chance to engage in duels in case this player wants
;1125:		//to engage again right after he's done fighting and someone else is waiting.
;1126:		//JediDog: Changed 10000 to 3000 so the time would be less annoying
;1127:		ent->client->ps.fd.privateDuelTime = level.time + 3000;
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
line 1129
;1128:
;1129:		if (ent->client->ps.duelTime < level.time)
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
;1130:		{
line 1132
;1131:			//Bring out the sabers
;1132:			if (ent->client->ps.weapon == WP_SABER && ent->client->ps.saberHolstered &&
ADDRLP4 424
ADDRFP4 0
INDIRP4
CNSTI4 408
...
EQI4 $509
line 1134
;1133:				ent->client->ps.duelTime)
;1134:			{
line 1135
;1135:				if (!saberOffSound || !saberOnSound)
ADDRLP4 432
CNSTI4 0
ASGNI4
...
;1136:				{
line 1137
;1137:					saberOffSound = G_SoundIndex("sound/weapons/saber/saberoffquick.wav");
ADDRGP4 $514
ARGP4
ADDRLP4 436
ADDRGP4 G_SoundIndex
...
ASGNI4
line 1138
;1138:					saberOnSound = G_SoundIndex("sound/weapons/saber/saberon.wav");
ADDRGP4 $515
ARGP4
ADDRLP4 440
ADDRGP4 G_SoundIndex
...
line 1141
;1140:
;1141:				ent->client->ps.saberHolstered = qfalse;
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
ASGNI4
line 1142
;1142:				G_Sound(ent, CHAN_AUTO, saberOnSound);
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 0
...
line 1144
;1143:
;1144:				G_AddEvent(ent, EV_PRIVATE_DUEL, 2);
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 13
...
line 1149
;1148:
;1149:			if (duelAgainst && duelAgainst->client && duelAgainst->inuse &&
ADDRLP4 436
CNSTU4 0
ASGNU4
ADDRLP4 420
...
EQI4 $507
line 1152
;1150:				duelAgainst->client->ps.weapon == WP_SABER && duelAgainst->client->ps.saberHolstered &&
;1151:				duelAgainst->client->ps.duelTime)
;1152:			{
line 1153
;1153:				if (!saberOffSound || !saberOnSound)
ADDRLP4 448
CNSTI4 0
ASGNI4
ADDRGP4 saberOffSound
...
;1154:				{
line 1155
;1155:					saberOffSound = G_SoundIndex("sound/weapons/saber/saberoffquick.wav");
ADDRGP4 $514
ARGP4
ADDRLP4 452
ADDRGP4 G_SoundIndex
...
ASGNI4
line 1156
;1156:					saberOnSound = G_SoundIndex("sound/weapons/saber/saberon.wav");
ADDRGP4 $515
ARGP4
ADDRLP4 456
ADDRGP4 G_SoundIndex
...
line 1159
;1158:
;1159:				duelAgainst->client->ps.saberHolstered = qfalse;
ADDRLP4 420
INDIRP4
CNSTI4 408
ADDP4
...
ASGNI4
line 1160
;1160:				G_Sound(duelAgainst, CHAN_AUTO, saberOnSound);
ADDRLP4 420
INDIRP4
ARGP4
CNSTI4 0
...
line 1162
;1161:
;1162:				G_AddEvent(duelAgainst, EV_PRIVATE_DUEL, 2);
ADDRLP4 420
INDIRP4
ARGP4
CNSTI4 13
...
line 1164
;1163:
;1164:				duelAgainst->client->ps.duelTime = 0;
ADDRLP4 420
INDIRP4
CNSTI4 408
ADDP4
...
line 1176
;1175:
;1176:		if (!duelAgainst || !duelAgainst->client || !duelAgainst->inuse ||
ADDRLP4 428
CNSTU4 0
ASGNU4
ADDRLP4 420
...
LABELV $525
line 1178
;1177:			duelAgainst->client->ps.duelIndex != ent->s.number)
;1178:		{
line 1179
;1179:			ent->client->ps.duelInProgress = 0;
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
ASGNI4
line 1180
;1180:			G_AddEvent(ent, EV_PRIVATE_DUEL, 0);
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 13
...
LABELV $521
line 1182
;1182:		else if (duelAgainst->health < 1 || duelAgainst->client->ps.stats[STAT_HEALTH] < 1)
ADDRLP4 440
CNSTI4 1
ASGNI4
ADDRLP4 420
...
;1183:		{
line 1184
;1184:			ent->client->ps.duelInProgress = 0;
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
ASGNI4
line 1185
;1185:			duelAgainst->client->ps.duelInProgress = 0;
ADDRLP4 420
INDIRP4
CNSTI4 408
ADDP4
...
line 1187
;1186:
;1187:			G_AddEvent(ent, EV_PRIVATE_DUEL, 0);
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 13
...
pop
line 1188
;1188:			G_AddEvent(duelAgainst, EV_PRIVATE_DUEL, 0);
ADDRLP4 420
INDIRP4
ARGP4
CNSTI4 13
...
line 1191
;1189:
;1190:			//Winner gets full health.. providing he's still alive
...
;1192:			{
line 1193
;1193:				if (ent->health < ent->client->ps.stats[STAT_MAX_HEALTH])
ADDRLP4 452
ADDRFP4 0
INDIRP4
ASGNP4
...
;1194:				{
line 1195
;1195:					ent->client->ps.stats[STAT_HEALTH] = ent->health = ent->client->ps.stats[STAT_MAX_HEALTH];
ADDRLP4 456
ADDRFP4 0
INDIRP4
ASGNP4
...
line 1198
;1197:
;1198:				if (g_spawnInvulnerability.integer)
...
;1199:				{
line 1200
;1200:					ent->client->ps.eFlags |= EF_INVULNERABLE;
ADDRLP4 456
ADDRFP4 0
INDIRP4
CNSTI4 408
...
ASGNI4
line 1201
;1201:					ent->client->invulnerableTimer = level.time + g_spawnInvulnerability.integer;
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
;1204:
;1205:			/*
;1206:			trap_SendServerCommand( ent-g_entities, va("print \"%s %s\n\"", ent->client->pers.netname, G_GetStripEdString("SVINGAME", "PLDUELWINNER")) );
;1207:			trap_SendServerCommand( duelAgainst-g_entities, va("print \"%s %s\n\"", ent->client->pers.netname, G_GetStripEdString("SVINGAME", "PLDUELWINNER")) );
;1208:			*/
;1209:			//Private duel announcements are now made globally because we only want one duel at a time.
;1210:			if (ent->health > 0 && ent->client->ps.stats[STAT_HEALTH] > 0)
ADDRLP4 452
ADDRFP4 0
INDIRP4
ASGNP4
...
line 1215
;1214:			else
;1215:			{ //it was a draw, because we both managed to die in the same frame
line 1216
;1216:				trap_SendServerCommand( -1, va("cp \"%s\n\"", G_GetStripEdString("SVINGAME", "PLDUELTIE")) );
ADDRGP4 $541
ARGP4
ADDRGP4 $544
ARGP4
...
line 1224
;1223:
;1224:			VectorSubtract(ent->client->ps.origin, duelAgainst->client->ps.origin, vSub);
ADDRLP4 460
CNSTI4 408
ASGNI4
ADDRLP4 464
...
;1228:			{
line 1229
;1229:				ent->client->ps.duelInProgress = 0;
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
ASGNI4
line 1230
;1230:				duelAgainst->client->ps.duelInProgress = 0;
ADDRLP4 420
INDIRP4
CNSTI4 408
ADDP4
...
line 1232
;1231:
;1232:				G_AddEvent(ent, EV_PRIVATE_DUEL, 0);
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 13
...
pop
line 1233
;1233:				G_AddEvent(duelAgainst, EV_PRIVATE_DUEL, 0);
ADDRLP4 420
INDIRP4
ARGP4
CNSTI4 13
...
line 1235
;1234:
;1235:				trap_SendServerCommand( -1, va("print \"%s\n\"", G_GetStripEdString("SVINGAME", "PLDUELSTOP")) );
ADDRGP4 $541
ARGP4
ADDRGP4 $550
ARGP4
...
;1239:
;1240:	/*
;1241:	if ( client->ps.powerups[PW_HASTE] ) {
;1242:		client->ps.speed *= 1.3;
;1243:	}
;1244:	*/
;1245:
;1246:	if (client->ps.usingATST && ent->health > 0)
ADDRLP4 420
CNSTI4 0
ASGNI4
ADDRLP4 4
...
LEI4 $551
line 1247
;1247:	{ //we have special shot clip boxes as an ATST
line 1248
;1248:		ent->r.contents |= CONTENTS_NOSHOT;
ADDRLP4 424
ADDRFP4 0
INDIRP4
CNSTI4 340
...
ASGNI4
line 1249
;1249:		ATST_ManageDamageBoxes(ent);
ADDRFP4 0
INDIRP4
ARGP4
...
;1252:	{
line 1253
;1253:		ent->r.contents &= ~CONTENTS_NOSHOT;
ADDRLP4 424
ADDRFP4 0
INDIRP4
CNSTI4 340
...
ASGNI4
line 1254
;1254:		client->damageBoxHandle_Head = 0;
ADDRLP4 4
INDIRP4
CNSTI4 1652
ADDP4
...
ASGNI4
line 1255
;1255:		client->damageBoxHandle_RLeg = 0;
ADDRLP4 4
INDIRP4
CNSTI4 1656
ADDP4
...
ASGNI4
line 1256
;1256:		client->damageBoxHandle_LLeg = 0;
ADDRLP4 4
INDIRP4
CNSTI4 1660
ADDP4
...
line 1263
;1258:
;1259:	//rww - moved this stuff into the pmove code so that it's predicted properly
;1260:	//BG_AdjustClientSpeed(&client->ps, &client->pers.cmd, level.time);
;1261:
;1262:	// set up for pmove
;1263:	oldEventSequence = client->ps.eventSequence;
ADDRLP4 396
ADDRLP4 4
INDIRP4
CNSTI4 112
...
line 1267
;1266:
;1267:	if ( ent->flags & FL_FORCE_GESTURE ) {
ADDRFP4 0
INDIRP4
CNSTI4 472
ADDP4
...
EQI4 $553
line 1268
;1268:		ent->flags &= ~FL_FORCE_GESTURE;
ADDRLP4 424
ADDRFP4 0
INDIRP4
CNSTI4 472
...
ASGNI4
line 1269
;1269:		ent->client->pers.cmd.buttons |= BUTTON_GESTURE;
ADDRLP4 428
ADDRFP4 0
INDIRP4
CNSTI4 408
...
line 1272
;1271:
;1272:	if (ent->client && ent->client->ps.fallingToDeath &&
ADDRLP4 424
ADDRFP4 0
INDIRP4
CNSTI4 408
...
LEI4 $555
line 1274
;1273:		(level.time - FALL_FADE_TIME) > ent->client->ps.fallingToDeath)
;1274:	{ //die!
line 1275
;1275:		player_die(ent, ent, ent, 100000, MOD_FALLING);
ADDRLP4 432
ADDRFP4 0
INDIRP4
ASGNP4
...
pop
line 1277
;1277:		ent->client->ps.fallingToDeath = 0;
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
line 1279
;1278:
;1279:		G_MuteSound(ent->s.number, CHAN_VOICE); //stop screaming, because you are dead!
ADDRFP4 0
INDIRP4
INDIRI4
ARGI4
...
line 1282
;1281:
;1282:	if (ent->client->ps.otherKillerTime > level.time &&
ADDRLP4 432
ADDRFP4 0
INDIRP4
CNSTI4 408
...
GEI4 $558
line 1285
;1283:		ent->client->ps.groundEntityNum != ENTITYNUM_NONE &&
;1284:		ent->client->ps.otherKillerDebounceTime < level.time)
;1285:	{
line 1286
;1286:		ent->client->ps.otherKillerTime = 0;
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
ASGNI4
line 1287
;1287:		ent->client->ps.otherKiller = ENTITYNUM_NONE;
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
LABELV $558
line 1289
;1289:	else if (ent->client->ps.otherKillerTime > level.time &&
ADDRLP4 436
ADDRFP4 0
INDIRP4
CNSTI4 408
...
NEI4 $562
line 1291
;1290:		ent->client->ps.groundEntityNum == ENTITYNUM_NONE)
;1291:	{
line 1292
;1292:		if (ent->client->ps.otherKillerDebounceTime < (level.time + 100))
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
;1293:		{
line 1294
;1294:			ent->client->ps.otherKillerDebounceTime = level.time + 100;
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
line 1301
;1297:
;1298://	WP_ForcePowersUpdate( ent, msec, ucmd); //update any active force powers
;1299://	WP_SaberPositionUpdate(ent, ucmd); //check the server-side saber point, do apprioriate server-side actions (effects are cs-only)
;1300:
;1301:	if ((ent->client->pers.cmd.buttons & BUTTON_USE) && ent->client->ps.useDelay < level.time)
ADDRLP4 440
ADDRFP4 0
INDIRP4
CNSTI4 408
...
pop
line 1304
;1304:		ent->client->ps.useDelay = level.time + 100;
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
NEI4 $574
line 1310
;1310:		pm.tracemask = MASK_PLAYERSOLID & ~CONTENTS_BODY;
ADDRLP4 8+32
CNSTI4 17
ASGNI4
line 1311
...
LABELV $574
line 1312
;1312:	else if ( ent->r.svFlags & SVF_BOT ) {
ADDRFP4 0
INDIRP4
CNSTI4 304
ADDP4
...
EQI4 $577
line 1313
;1313:		pm.tracemask = MASK_PLAYERSOLID | CONTENTS_MONSTERCLIP;
ADDRLP4 8+32
CNSTI4 305
ASGNI4
line 1314
...
;1315:	else {
line 1316
;1316:		pm.tracemask = MASK_PLAYERSOLID;
ADDRLP4 8+32
CNSTI4 273
ASGNI4
line 1317
...
LABELV $575
line 1318
;1318:	pm.trace = trap_Trace;
ADDRLP4 8+240
ADDRGP4 trap_Trace
ASGNP4
line 1319
;1319:	pm.pointcontents = trap_PointContents;
ADDRLP4 8+244
ADDRGP4 trap_PointContents
ASGNP4
line 1320
;1320:	pm.debugLevel = g_debugMove.integer;
ADDRLP4 8+36
ADDRGP4 g_debugMove+12
INDIRI4
ASGNI4
line 1321
;1321:	pm.noFootsteps = ( g_dmflags.integer & DF_NO_FOOTSTEPS ) > 0;
ADDRGP4 g_dmflags+12
INDIRI4
CNSTI4 32
BANDI4
...
line 1323
;1322:
;1323:	pm.pmove_fixed = pmove_fixed.integer | client->pers.pmoveFixed;
ADDRLP4 8+232
ADDRGP4 pmove_fixed+12
INDIRI4
ADDRLP4 4
...
ASGNI4
line 1324
;1324:	pm.pmove_msec = pmove_msec.integer;
ADDRLP4 8+236
ADDRGP4 pmove_msec+12
INDIRI4
ASGNI4
line 1326
;1325:
;1326:	pm.animations = bgGlobalAnimations;//NULL;
ADDRLP4 8+224
ADDRGP4 bgGlobalAnimations
ASGNP4
line 1328
;1327:
;1328:	pm.gametype = g_gametype.integer;
ADDRLP4 8+220
ADDRGP4 g_gametype+12
INDIRI4
ASGNI4
line 1330
;1329:
;1330:	VectorCopy( client->ps.origin, client->oldOrigin );
ADDRLP4 4
INDIRP4
CNSTI4 1612
ADDP4
...
line 1332
;1331:
;1332:	if (level.intermissionQueued != 0 && g_singlePlayer.integer) {
ADDRLP4 456
CNSTI4 0
ASGNI4
ADDRGP4 level+9004
...
EQI4 $597
line 1333
;1333:		if ( level.time - level.intermissionQueued >= 1000  ) {
ADDRGP4 level+32
INDIRI4
ADDRGP4 level+9004
INDIRI4
...
LTI4 $601
line 1334
;1334:			pm.cmd.buttons = 0;
ADDRLP4 8+4+16
CNSTI4 0
ASGNI4
line 1335
;1335:			pm.cmd.forwardmove = 0;
ADDRLP4 8+4+24
CNSTI1 0
ASGNI1
line 1336
;1336:			pm.cmd.rightmove = 0;
ADDRLP4 8+4+25
CNSTI1 0
ASGNI1
line 1337
;1337:			pm.cmd.upmove = 0;
ADDRLP4 8+4+26
CNSTI1 0
ASGNI1
line 1338
;1338:			if ( level.time - level.intermissionQueued >= 2000 && level.time - level.intermissionQueued <= 2500 ) {
ADDRGP4 level+32
INDIRI4
ADDRGP4 level+9004
INDIRI4
...
GTI4 $613
line 1339
;1339:				trap_SendConsoleCommand( EXEC_APPEND, "centerview\n");
CNSTI4 2
ARGI4
ADDRGP4 $619
ARGP4
...
LABELV $613
line 1341
;1341:			ent->client->ps.pm_type = PM_SPINTERMISSION;
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
;1346:	{
line 1347
;1347:		if (g_entities[i].inuse && g_entities[i].client)
ADDRLP4 460
CNSTI4 832
ADDRLP4 0
INDIRI4
...
;1348:		{
line 1349
;1349:			pm.bgClients[i] = &g_entities[i].client->ps;
ADDRLP4 0
INDIRI4
CNSTI4 2
LSHI4
...
line 1353
;1352:
;1353:	if (ent->client->ps.saberLockTime > level.time)
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
;1354:	{
line 1355
;1355:		gentity_t *blockOpp = &g_entities[ent->client->ps.saberLockEnemy];
ADDRLP4 460
CNSTI4 832
ADDRFP4 0
INDIRP4
...
line 1357
;1356:
;1357:		if (blockOpp && blockOpp->inuse && blockOpp->client)
ADDRLP4 468
CNSTU4 0
ASGNU4
ADDRLP4 460
...
;1358:		{
line 1362
;1359:			vec3_t lockDir, lockAng;
;1360:
;1361:			//VectorClear( ent->client->ps.velocity );
;1362:			VectorSubtract( blockOpp->r.currentOrigin, ent->r.currentOrigin, lockDir );
ADDRLP4 500
CNSTI4 368
ASGNI4
ADDRLP4 504
...
ASGNF4
line 1364
;1363:			//lockAng[YAW] = vectoyaw( defDir );
;1364:			vectoangles(lockDir, lockAng);
ADDRLP4 472
ARGP4
ADDRLP4 484
ARGP4
...
pop
line 1365
;1365:			SetClientViewAngle( ent, lockAng );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 484
...
line 1368
;1367:
;1368:		if ( ( ent->client->buttons & BUTTON_ATTACK ) && ! ( ent->client->oldbuttons & BUTTON_ATTACK ) )
ADDRLP4 472
ADDRFP4 0
INDIRP4
CNSTI4 408
...
;1369:		{
line 1370
;1370:			ent->client->ps.saberLockHits++;
ADDRLP4 484
ADDRFP4 0
INDIRP4
CNSTI4 408
...
LABELV $637
line 1372
;1372:		if (ent->client->ps.saberLockHits > 2)
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
;1373:		{
line 1374
;1374:			if (!ent->client->ps.saberLockAdvance)
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
;1375:			{
line 1376
;1376:				ent->client->ps.saberLockHits -= 3;
ADDRLP4 484
ADDRFP4 0
INDIRP4
CNSTI4 408
...
LABELV $641
line 1378
;1378:			ent->client->ps.saberLockAdvance = qtrue;
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
;1382:	{
line 1383
;1383:		ent->client->ps.saberLockFrame = 0;
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
ASGNI4
line 1385
;1384:		//check for taunt
;1385:		if ( (pm.cmd.generic_cmd == GENCMD_ENGAGE_DUEL) && (g_gametype.integer == GT_TOURNAMENT) )
ADDRLP4 8+4+23
INDIRU1
CVUI4 1
CNSTI4 2
...
NEI4 $643
line 1386
;1386:		{//already in a duel, make it a taunt command
line 1387
;1387:			pm.cmd.buttons |= BUTTON_GESTURE;
ADDRLP4 8+4+16
ADDRLP4 8+4+16
INDIRI4
CNSTI4 8
...
;1394:	{
line 1395
;1395:		if (pm.checkDuelLoss > 0 && pm.checkDuelLoss <= MAX_CLIENTS)
ADDRLP4 8+376
INDIRI4
CNSTI4 0
LEI4 $653
...
;1396:		{
line 1397
;1397:			gentity_t *clientLost = &g_entities[pm.checkDuelLoss-1];
ADDRLP4 460
CNSTI4 832
ADDRLP4 8+376
INDIRI4
...
line 1399
;1398:
;1399:			if (clientLost && clientLost->inuse && clientLost->client && Q_irand(0, 40) > clientLost->health)
ADDRLP4 468
CNSTU4 0
ASGNU4
ADDRLP4 460
...
line 1402
;1401:				vec3_t attDir;
;1402:				VectorSubtract(ent->client->ps.origin, clientLost->client->ps.origin, attDir);
ADDRLP4 492
CNSTI4 408
ASGNI4
ADDRLP4 496
...
line 1405
;1404:
;1405:				VectorClear(clientLost->client->ps.velocity);
ADDRLP4 520
ADDRLP4 460
INDIRP4
CNSTI4 408
...
ASGNF4
line 1406
;1406:				clientLost->client->ps.forceHandExtend = HANDEXTEND_NONE;
ADDRLP4 460
INDIRP4
CNSTI4 408
ADDP4
...
ASGNI4
line 1407
;1407:				clientLost->client->ps.forceHandExtendTime = 0;
ADDRLP4 460
INDIRP4
CNSTI4 408
ADDP4
...
line 1409
;1408:
;1409:				gGAvoidDismember = 1;
ADDRGP4 gGAvoidDismember
CNSTI4 1
ASGNI4
line 1410
;1410:				G_Damage(clientLost, ent, ent, attDir, clientLost->client->ps.origin, 9999, DAMAGE_NO_PROTECTION, MOD_SABER);
ADDRLP4 460
INDIRP4
ARGP4
ADDRLP4 532
...
;1413:				{
line 1414
;1414:					gGAvoidDismember = 2;
ADDRGP4 gGAvoidDismember
CNSTI4 2
ASGNI4
line 1415
;1415:					G_CheckForDismemberment(clientLost, clientLost->client->ps.origin, 999, (clientLost->client->ps.legsAnim&~ANIM_TOGGLEBIT));
ADDRLP4 460
INDIRP4
ARGP4
ADDRLP4 540
...
line 1425
;1424:
;1425:	switch(pm.cmd.generic_cmd)
ADDRLP4 460
ADDRLP4 8+4+23
INDIRU1
CVUI4 1
...
LABELV $672
line 1430
;1429:	case GENCMD_SABERSWITCH:
;1430:		Cmd_ToggleSaber_f(ent);
ADDRFP4 0
INDIRP4
ARGP4
...
LABELV $673
line 1433
;1432:	case GENCMD_ENGAGE_DUEL:
;1433:		if ( g_gametype.integer == GT_TOURNAMENT )
ADDRGP4 g_gametype+12
INDIRI4
CNSTI4 3
NEI4 $674
line 1434
;1434:		{//already in a duel, made it a taunt command
line 1435
;1435:		}
ADDRGP4 $667
JUMPV
...
LABELV $678
line 1445
;1444:	case GENCMD_FORCE_SPEED:
;1445:		ForceSpeed(ent, 0);
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 0
...
LABELV $679
line 1448
;1447:	case GENCMD_FORCE_THROW:
;1448:		ForceThrow(ent, qfalse);
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 0
...
LABELV $680
line 1451
;1450:	case GENCMD_FORCE_PULL:
;1451:		ForceThrow(ent, qtrue);
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 1
...
LABELV $681
line 1454
;1453:	case GENCMD_FORCE_DISTRACT:
;1454:		ForceTelepathy(ent);
ADDRFP4 0
INDIRP4
ARGP4
...
LABELV $683
line 1460
;1459:	case GENCMD_FORCE_PROTECT:
;1460:		ForceProtect(ent);
ADDRFP4 0
INDIRP4
ARGP4
...
LABELV $684
line 1463
;1462:	case GENCMD_FORCE_ABSORB:
;1463:		ForceAbsorb(ent);
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 ForceAbsorb
...
LABELV $685
line 1466
;1465:	case GENCMD_FORCE_HEALOTHER:
;1466:		ForceTeamHeal(ent);
ADDRFP4 0
INDIRP4
ARGP4
...
LABELV $686
line 1469
;1468:	case GENCMD_FORCE_FORCEPOWEROTHER:
;1469:		ForceTeamForceReplenish(ent);
ADDRFP4 0
INDIRP4
ARGP4
...
LABELV $687
line 1472
;1471:	case GENCMD_FORCE_SEEING:
;1472:		ForceSeeing(ent);
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 ForceSeeing
...
LABELV $688
line 1475
;1474:	case GENCMD_USE_SEEKER:
;1475:		if ( (ent->client->ps.stats[STAT_HOLDABLE_ITEMS] & (1 << HI_SEEKER)) &&
ADDRLP4 468
ADDRFP4 0
INDIRP4
CNSTI4 408
...
EQI4 $667
line 1477
;1476:			G_ItemUsable(&ent->client->ps, HI_SEEKER) )
;1477:		{
line 1478
;1478:			ItemUse_Seeker(ent);
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 ItemUse_Seeker
...
pop
line 1479
;1479:			G_AddEvent(ent, EV_USE_ITEM0+HI_SEEKER, 0);
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 41
...
pop
line 1480
;1480:			ent->client->ps.stats[STAT_HOLDABLE_ITEMS] &= ~(1 << HI_SEEKER);
ADDRLP4 476
ADDRFP4 0
INDIRP4
CNSTI4 408
...
LABELV $691
line 1484
;1483:	case GENCMD_USE_FIELD:
;1484:		if ( (ent->client->ps.stats[STAT_HOLDABLE_ITEMS] & (1 << HI_SHIELD)) &&
ADDRLP4 476
ADDRFP4 0
INDIRP4
CNSTI4 408
...
EQI4 $667
line 1486
;1485:			G_ItemUsable(&ent->client->ps, HI_SHIELD) )
;1486:		{
line 1487
;1487:			ItemUse_Shield(ent);
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 ItemUse_Shield
...
pop
line 1488
;1488:			G_AddEvent(ent, EV_USE_ITEM0+HI_SHIELD, 0);
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 42
...
pop
line 1489
;1489:			ent->client->ps.stats[STAT_HOLDABLE_ITEMS] &= ~(1 << HI_SHIELD);
ADDRLP4 484
ADDRFP4 0
INDIRP4
CNSTI4 408
...
LABELV $694
line 1493
;1492:	case GENCMD_USE_BACTA:
;1493:		if ( (ent->client->ps.stats[STAT_HOLDABLE_ITEMS] & (1 << HI_MEDPAC)) &&
ADDRLP4 484
ADDRFP4 0
INDIRP4
CNSTI4 408
...
EQI4 $667
line 1495
;1494:			G_ItemUsable(&ent->client->ps, HI_MEDPAC) )
;1495:		{
line 1496
;1496:			ItemUse_MedPack(ent);
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 ItemUse_MedPack
...
pop
line 1497
;1497:			G_AddEvent(ent, EV_USE_ITEM0+HI_MEDPAC, 0);
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 43
...
pop
line 1498
;1498:			ent->client->ps.stats[STAT_HOLDABLE_ITEMS] &= ~(1 << HI_MEDPAC);
ADDRLP4 492
ADDRFP4 0
INDIRP4
CNSTI4 408
...
LABELV $697
line 1502
;1501:	case GENCMD_USE_ELECTROBINOCULARS:
...
LABELV $702
line 1517
;1516:	case GENCMD_ZOOM:
;1517:		if ( (ent->client->ps.stats[STAT_HOLDABLE_ITEMS] & (1 << HI_BINOCULARS)) &&
ADDRLP4 500
ADDRFP4 0
INDIRP4
CNSTI4 408
...
EQI4 $667
line 1519
;1518:			G_ItemUsable(&ent->client->ps, HI_BINOCULARS) )
;1519:		{
line 1520
;1520:			ItemUse_Binoculars(ent);
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 ItemUse_Binoculars
...
pop
line 1521
;1521:			if (ent->client->ps.zoomMode == 0)
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
;1522:			{
line 1523
;1523:				G_AddEvent(ent, EV_USE_ITEM0+HI_BINOCULARS, 1);
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 45
...
;1526:			{
line 1527
;1527:				G_AddEvent(ent, EV_USE_ITEM0+HI_BINOCULARS, 2);
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 45
...
LABELV $707
line 1532
;1531:	case GENCMD_USE_SENTRY:
;1532:		if ( (ent->client->ps.stats[STAT_HOLDABLE_ITEMS] & (1 << HI_SENTRY_GUN)) &&
ADDRLP4 508
ADDRFP4 0
INDIRP4
CNSTI4 408
...
EQI4 $667
line 1534
;1533:			G_ItemUsable(&ent->client->ps, HI_SENTRY_GUN) )
;1534:		{
line 1535
;1535:			ItemUse_Sentry(ent);
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 ItemUse_Sentry
...
pop
line 1536
;1536:			G_AddEvent(ent, EV_USE_ITEM0+HI_SENTRY_GUN, 0);
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 46
...
pop
line 1537
;1537:			ent->client->ps.stats[STAT_HOLDABLE_ITEMS] &= ~(1 << HI_SENTRY_GUN);
ADDRLP4 516
ADDRFP4 0
INDIRP4
CNSTI4 408
...
LABELV $710
line 1541
;1540:	case GENCMD_SABERATTACKCYCLE:
;1541:		Cmd_SaberAttackCycle_f(ent);
ADDRFP4 0
INDIRP4
ARGP4
...
;1545:	}
;1546:
;1547:	// save results of pmove
;1548:	if ( ent->client->ps.eventSequence != oldEventSequence ) {
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
LABELV $712
line 1551
;1551:	if (g_smoothClients.integer) {
ADDRGP4 g_smoothClients+12
INDIRI4
CNSTI4 0
EQI4 $715
line 1552
;1552:		BG_PlayerStateToEntityStateExtraPolate( &ent->client->ps, &ent->s, ent->client->ps.commandTime, qtrue );
ADDRLP4 468
ADDRFP4 0
INDIRP4
ASGNP4
...
;1554:	else {
line 1555
;1555:		BG_PlayerStateToEntityState( &ent->client->ps, &ent->s, qtrue );
ADDRLP4 468
ADDRFP4 0
INDIRP4
ASGNP4
...
LABELV $716
line 1557
;1557:	SendPendingPredictableEvents( &ent->client->ps );
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
line 1559
;1558:
;1559:	if ( !( ent->client->ps.eFlags & EF_FIRING ) ) {
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
NEI4 $718
line 1560
;1560:		client->fireHeld = qfalse;		// for grapple
ADDRLP4 4
INDIRP4
CNSTI4 1712
ADDP4
...
line 1564
;1562:
;1563:	// use the snapped origin for linking so it matches client predicted versions
;1564:	VectorCopy( ent->s.pos.trBase, ent->r.currentOrigin );
ADDRLP4 468
ADDRFP4 0
INDIRP4
ASGNP4
...
line 1566
;1565:
;1566:	VectorCopy (pm.mins, ent->r.mins);
ADDRFP4 0
INDIRP4
CNSTI4 316
ADDP4
...
ASGNB 12
line 1567
;1567:	VectorCopy (pm.maxs, ent->r.maxs);
ADDRFP4 0
INDIRP4
CNSTI4 328
ADDP4
...
line 1569
;1568:
;1569:	ent->waterlevel = pm.waterlevel;
ADDRFP4 0
INDIRP4
CNSTI4 748
ADDP4
...
ASGNI4
line 1570
;1570:	ent->watertype = pm.watertype;
ADDRFP4 0
INDIRP4
CNSTI4 744
ADDP4
...
line 1573
;1571:
;1572:	// execute client events
;1573:	ClientEvents( ent, oldEventSequence );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 396
...
line 1582
;1580:
;1581:	// link entity now, after any personal teleporters have been used
;1582:	trap_LinkEntity (ent);
ADDRFP4 0
INDIRP4
ARGP4
...
line 1588
;1586:
;1587:	// NOTE: now copy the exact origin over otherwise clients can be snapped into solid
;1588:	VectorCopy( ent->client->ps.origin, ent->r.currentOrigin );
ADDRLP4 472
ADDRFP4 0
INDIRP4
ASGNP4
...
line 1594
;1589:
;1590:	//test for solid areas in the AAS file
;1591://	BotTestAAS(ent->r.currentOrigin);
;1592:
;1593:	// touch other objects
;1594:	ClientImpacts( ent, &pm );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 8
...
line 1597
;1595:
;1596:	// save results of triggers and client events
;1597:	if (ent->client->ps.eventSequence != oldEventSequence) {
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
line 1602
;1600:
;1601:	// swap and latch button actions
;1602:	client->oldbuttons = client->buttons;
ADDRLP4 4
INDIRP4
CNSTI4 1604
ADDP4
...
ASGNI4
line 1603
;1603:	client->buttons = ucmd->buttons;
ADDRLP4 4
INDIRP4
CNSTI4 1600
ADDP4
...
ASGNI4
line 1604
;1604:	client->latched_buttons |= client->buttons & ~client->oldbuttons;
ADDRLP4 484
ADDRLP4 4
INDIRP4
CNSTI4 1608
...
line 1607
;1605:
;1606:	// Did we kick someone in our pmove sequence?
;1607:	if (client->ps.forceKickFlip)
ADDRLP4 4
INDIRP4
CNSTI4 1292
ADDP4
...
;1608:	{
line 1609
;1609:		gentity_t *faceKicked = &g_entities[client->ps.forceKickFlip-1];
ADDRLP4 488
CNSTI4 832
ADDRLP4 4
INDIRP4
...
line 1611
;1610:
;1611:		if (faceKicked && faceKicked->client && (!OnSameTeam(ent, faceKicked) || g_friendlyFire.integer) &&
ADDRLP4 496
CNSTU4 0
ASGNU4
ADDRLP4 488
...
LABELV $740
line 1614
;1612:			(!faceKicked->client->ps.duelInProgress || faceKicked->client->ps.duelIndex == ent->s.number) &&
;1613:			(!ent->client->ps.duelInProgress || ent->client->ps.duelIndex == faceKicked->s.number))
;1614:		{
line 1615
;1615:			if ( faceKicked && faceKicked->client && faceKicked->health && faceKicked->takedamage )
ADDRLP4 520
CNSTU4 0
ASGNU4
ADDRLP4 488
...
EQI4 $741
line 1616
;1616:			{//push them away and do pain
line 1618
;1617:				vec3_t oppDir;
;1618:				int strength = (int)VectorNormalize2( client->ps.velocity, oppDir );
ADDRLP4 4
INDIRP4
CNSTI4 32
ADDP4
...
line 1622
;1621:
;1622:				VectorScale( oppDir, -1, oppDir );
ADDRLP4 548
CNSTF4 3212836864
ASGNF4
ADDRLP4 532
...
line 1624
;1623:
;1624:				G_Damage( faceKicked, ent, ent, oppDir, client->ps.origin, strength, DAMAGE_NO_ARMOR, MOD_MELEE );
ADDRLP4 488
INDIRP4
ARGP4
ADDRLP4 552
...
line 1626
;1625:
;1626:				if ( faceKicked->client->ps.weapon != WP_SABER ||
ADDRLP4 560
ADDRLP4 488
INDIRP4
CNSTI4 408
...
LABELV $750
line 1629
;1627:					 faceKicked->client->ps.fd.saberAnimLevel < FORCE_LEVEL_3 ||
;1628:					 (!BG_SaberInAttack(faceKicked->client->ps.saberMove) && !PM_SaberInStart(faceKicked->client->ps.saberMove) && !PM_SaberInReturn(faceKicked->client->ps.saberMove) && !PM_SaberInTransition(faceKicked->client->ps.saberMove)) )
;1629:				{
line 1630
;1630:					if (faceKicked->health > 0 &&
ADDRLP4 584
CNSTI4 0
ASGNI4
ADDRLP4 488
...
EQI4 $751
line 1633
;1631:						faceKicked->client->ps.stats[STAT_HEALTH] > 0 &&
;1632:						faceKicked->client->ps.forceHandExtend != HANDEXTEND_KNOCKDOWN)
;1633:					{
line 1634
;1634:						if (Q_irand(1, 10) <= 3)
CNSTI4 1
ARGI4
CNSTI4 10
ARGI4
...
GTI4 $753
line 1635
;1635:						{ //only actually knock over sometimes, but always do velocity hit
line 1636
;1636:							faceKicked->client->ps.forceHandExtend = HANDEXTEND_KNOCKDOWN;
ADDRLP4 488
INDIRP4
CNSTI4 408
ADDP4
...
ASGNI4
line 1637
;1637:							faceKicked->client->ps.forceHandExtendTime = level.time + 1100;
ADDRLP4 488
INDIRP4
CNSTI4 408
ADDP4
...
ASGNI4
line 1638
;1638:							faceKicked->client->ps.forceDodgeAnim = 0; //this toggles between 1 and 0, when it's 1 we should play the get up anim
ADDRLP4 488
INDIRP4
CNSTI4 408
ADDP4
...
line 1641
;1640:
;1641:						faceKicked->client->ps.otherKiller = ent->s.number;
ADDRLP4 488
INDIRP4
CNSTI4 408
ADDP4
...
ASGNI4
line 1642
;1642:						faceKicked->client->ps.otherKillerTime = level.time + 5000;
ADDRLP4 488
INDIRP4
CNSTI4 408
ADDP4
...
ASGNI4
line 1643
;1643:						faceKicked->client->ps.otherKillerDebounceTime = level.time + 100;
ADDRLP4 488
INDIRP4
CNSTI4 408
ADDP4
...
line 1645
;1644:
;1645:						faceKicked->client->ps.velocity[0] = oppDir[0]*(strength*40);
ADDRLP4 488
INDIRP4
CNSTI4 408
ADDP4
...
ASGNF4
line 1646
;1646:						faceKicked->client->ps.velocity[1] = oppDir[1]*(strength*40);
ADDRLP4 488
INDIRP4
CNSTI4 408
ADDP4
...
ASGNF4
line 1647
;1647:						faceKicked->client->ps.velocity[2] = 200;
ADDRLP4 488
INDIRP4
CNSTI4 408
ADDP4
...
line 1651
;1650:
;1651:				G_Sound( faceKicked, CHAN_AUTO, G_SoundIndex( va("sound/weapons/melee/punch%d", Q_irand(1, 4)) ) );
CNSTI4 1
ARGI4
CNSTI4 4
ARGI4
...
line 1655
;1654:
;1655:		client->ps.forceKickFlip = 0;
ADDRLP4 4
INDIRP4
CNSTI4 1292
ADDP4
...
line 1659
;1657:
;1658:	// check for respawning
;1659:	if ( client->ps.stats[STAT_HEALTH] <= 0 ) {
ADDRLP4 4
INDIRP4
CNSTI4 216
ADDP4
...
GTI4 $760
line 1661
;1660:		// wait for the attack button to be pressed
;1661:		if ( level.time > client->respawnTime && !gDoSlowMoDuel ) {
ADDRGP4 level+32
INDIRI4
ADDRLP4 4
INDIRP4
...
NEI4 $762
line 1663
;1662:			// forcerespawn is to prevent users from waiting out powerups
;1663:			if ( g_forcerespawn.integer > 0 && 
...
LEI4 $765
line 1664
;1664:				( level.time - client->respawnTime ) > g_forcerespawn.integer * 1000 ) {
line 1665
;1665:				respawn( ent );
ADDRFP4 0
INDIRP4
...
;1667:			}
;1668:		
;1669:			// pressing attack or use is the normal respawn method
;1670:			if ( ucmd->buttons & ( BUTTON_ATTACK | BUTTON_USE_HOLDABLE ) ) {
ADDRLP4 388
INDIRP4
CNSTI4 16
ADDP4
...
;1675:		{
line 1676
;1676:			client->respawnTime = level.time + 1000;
ADDRLP4 4
INDIRP4
CNSTI4 1688
ADDP4
...
;1679:	}
;1680:
;1681:	// perform once-a-second actions
;1682:	ClientTimerActions( ent, msec );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 392
...
line 1684
;1683:
;1684:	G_UpdateClientBroadcasts ( ent );
ADDRFP4 0
INDIRP4
ARGP4
...
;1687:/*
;1688:==================
;1689:G_CheckClientTimeouts
;1690:
;1691:Checks whether a client has exceded any timeouts and act accordingly
;1692:==================
;1693:*/
;1694:void G_CheckClientTimeouts ( gentity_t *ent )
;1695:{
line 1697
;1696:	// Only timeout supported right now is the timeout to spectator mode
;1697:	if ( !g_timeouttospec.integer )
...
;1700:	}
;1701:
;1702:	// Already a spectator, no need to boot them to spectator
;1703:	if ( ent->client->sess.sessionTeam == TEAM_SPECTATOR )
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
;1706:	}
;1707:
;1708:	// See how long its been since a command was received by the client and if its 
;1709:	// longer than the timeout to spectator then force this client into spectator mode
;1710:	if ( level.time - ent->client->pers.cmd.serverTime > g_timeouttospec.integer * 1000 )
ADDRGP4 level+32
INDIRI4
ADDRFP4 0
INDIRP4
...
;1718:ClientThink
;1719:
;1720:A new command has arrived from the client
;1721:==================
;1722:*/
;1723:void ClientThink( int clientNum ) {
line 1726
;1724:	gentity_t *ent;
;1725:
...
ASGNP4
line 1727
;1727:	trap_GetUsercmd( clientNum, &ent->client->pers.cmd );
ADDRFP4 0
INDIRI4
ARGI4
ADDRLP4 0
...
line 1731
;1728:
;1729:	// mark the time we got info, so we can display the
;1730:	// phone jack if they don't get any for a while
;1731:	ent->client->lastCmdTime = level.time;
ADDRLP4 0
INDIRP4
CNSTI4 408
ADDP4
...
line 1733
;1732:
;1733:	if ( !(ent->r.svFlags & SVF_BOT) && !g_synchronousClients.integer ) {
ADDRLP4 4
CNSTI4 0
ASGNI4
ADDRLP4 0
...
;1737:
;1738:
;1739:void G_RunClient( gentity_t *ent ) {
line 1740
;1740:	if ( !(ent->r.svFlags & SVF_BOT) && !g_synchronousClients.integer ) {
ADDRLP4 0
CNSTI4 0
ASGNI4
ADDRFP4 0
...
line 1743
;1742:	}
;1743:	ent->client->pers.cmd.serverTime = level.time;
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
;1748:/*
;1749:==================
;1750:SpectatorClientEndFrame
;1751:
;1752:==================
;1753:*/
;1754:void SpectatorClientEndFrame( gentity_t *ent ) {
line 1758
;1755:	gclient_t	*cl;
;1756:
;1757:	// if we are doing a chase cam or a remote view, grab the latest info
;1758:	if ( ent->client->sess.spectatorState == SPECTATOR_FOLLOW ) {
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
NEI4 $797
line 1761
;1759:		int		clientNum, flags;
;1760:
;1761:		clientNum = ent->client->sess.spectatorClient;
ADDRLP4 4
ADDRFP4 0
INDIRP4
CNSTI4 408
...
line 1764
;1762:
;1763:		// team follow1 and team follow2 go to whatever clients are playing
;1764:		if ( clientNum == -1 ) {
ADDRLP4 4
INDIRI4
CNSTI4 -1
NEI4 $799
line 1765
;1765:			clientNum = level.follow1;
ADDRLP4 4
ADDRGP4 level+212
INDIRI4
ASGNI4
line 1766
;1766:		} else if ( clientNum == -2 ) {
ADDRGP4 $800
JUMPV
LABELV $799
ADDRLP4 4
...
LTI4 $805
line 1770
;1770:			cl = &level.clients[ clientNum ];
ADDRLP4 0
CNSTI4 1812
ADDRLP4 4
INDIRI4
...
ASGNP4
line 1771
;1771:			if ( cl->pers.connected == CON_CONNECTED && cl->sess.sessionTeam != TEAM_SPECTATOR ) {
ADDRLP4 12
ADDRLP4 0
INDIRP4
ASGNP4
...
EQI4 $807
line 1772
;1772:				flags = (cl->ps.eFlags & ~(EF_VOTED | EF_TEAMVOTED)) | (ent->client->ps.eFlags & (EF_VOTED | EF_TEAMVOTED));
ADDRLP4 16
CNSTI4 108
ASGNI4
ADDRLP4 8
...
ASGNB 1380
line 1774
;1774:				ent->client->ps.pm_flags |= PMF_FOLLOW;
ADDRLP4 20
ADDRFP4 0
INDIRP4
CNSTI4 408
...
ASGNI4
line 1775
;1775:				ent->client->ps.eFlags = flags;
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
;1777:			} else {
line 1779
;1778:				// drop them to free spectators unless they are dedicated camera followers
;1779:				if ( ent->client->sess.spectatorClient >= 0 ) {
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
LTI4 $809
line 1780
;1780:					ent->client->sess.spectatorState = SPECTATOR_FREE;
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
ASGNI4
line 1781
;1781:					ClientBegin( ent->client - level.clients, qtrue );
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
line 1787
;1786:
;1787:	if ( ent->client->sess.spectatorState == SPECTATOR_SCOREBOARD ) {
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
NEI4 $811
line 1788
;1788:		ent->client->ps.pm_flags |= PMF_SCOREBOARD;
ADDRLP4 4
ADDRFP4 0
INDIRP4
CNSTI4 408
...
LABELV $811
line 1790
;1790:		ent->client->ps.pm_flags &= ~PMF_SCOREBOARD;
ADDRLP4 4
ADDRFP4 0
INDIRP4
CNSTI4 408
...
;1796:ClientEndFrame
;1797:
;1798:Called at the end of each server frame for each connected client
;1799:A fast client will have multiple ClientThink for each ClientEdFrame,
;1800:while a slow client may have multiple ClientEndFrame between ClientThink.
;1801:==============
;1802:*/
;1803:void ClientEndFrame( gentity_t *ent ) {
line 1807
;1804:	int			i;
;1805:	clientPersistant_t	*pers;
;1806:
...
NEI4 $814
line 1808
;1808:		SpectatorClientEndFrame( ent );
ADDRFP4 0
INDIRP4
ARGP4
...
line 1815
;1813:
;1814:	// turn off any expired powerups
;1815:	for ( i = 0 ; i < MAX_POWERUPS ; i++ ) {
ADDRLP4 0
CNSTI4 0
ASGNI4
LABELV $816
line 1816
;1816:		if ( ent->client->ps.powerups[ i ] < level.time ) {
ADDRLP4 0
INDIRI4
CNSTI4 2
LSHI4
...
GEI4 $820
line 1817
;1817:			ent->client->ps.powerups[ i ] = 0;
ADDRLP4 0
INDIRI4
CNSTI4 2
LSHI4
...
line 1833
;1820:
;1821:	// save network bandwidth
;1822:#if 0
;1823:	if ( !g_synchronousClients->integer && (ent->client->ps.pm_type == PM_NORMAL || ent->client->ps.pm_type == PM_FLOAT) ) {
;1824:		// FIXME: this must change eventually for non-sync demo recording
;1825:		VectorClear( ent->client->ps.viewangles );
;1826:	}
;1827:#endif
;1828:
;1829:	//
;1830:	// If the end of unit layout is displayed, don't give
;1831:	// the player any normal movement attributes
;1832:	//
;1833:	if ( level.intermissiontime ) {
ADDRGP4 level+9008
INDIRI4
CNSTI4 0
EQI4 $823
...
;1835:	}
;1836:
;1837:	// burn from lava, etc
;1838:	P_WorldEffects (ent);
ADDRFP4 0
INDIRP4
ARGP4
...
line 1841
;1839:
;1840:	// apply all the damage taken this frame
;1841:	P_DamageFeedback (ent);
ADDRFP4 0
INDIRP4
ARGP4
...
line 1844
;1842:
;1843:	// add the EF_CONNECTION flag if we haven't gotten commands recently
;1844:	if ( level.time - ent->client->lastCmdTime > 1000 ) {
ADDRGP4 level+32
INDIRI4
ADDRFP4 0
INDIRP4
...
LEI4 $826
line 1845
;1845:		ent->s.eFlags |= EF_CONNECTION;
ADDRLP4 8
ADDRFP4 0
INDIRP4
CNSTI4 8
...
LABELV $826
line 1847
;1847:		ent->s.eFlags &= ~EF_CONNECTION;
ADDRLP4 8
ADDRFP4 0
INDIRP4
CNSTI4 8
...
line 1850
;1849:
;1850:	ent->client->ps.stats[STAT_HEALTH] = ent->health;	// FIXME: get rid of ent->health...
ADDRLP4 8
ADDRFP4 0
INDIRP4
ASGNP4
...
line 1855
;1853:
;1854:	// set the latest infor
;1855:	if (g_smoothClients.integer) {
ADDRGP4 g_smoothClients+12
INDIRI4
CNSTI4 0
EQI4 $829
line 1856
;1856:		BG_PlayerStateToEntityStateExtraPolate( &ent->client->ps, &ent->s, ent->client->ps.commandTime, qtrue );
ADDRLP4 12
ADDRFP4 0
INDIRP4
ASGNP4
...
;1858:	else {
line 1859
;1859:		BG_PlayerStateToEntityState( &ent->client->ps, &ent->s, qtrue );
ADDRLP4 12
ADDRFP4 0
INDIRP4
ASGNP4
...
LABELV $830
line 1861
;1861:	SendPendingPredictableEvents( &ent->client->ps );
ADDRFP4 0
INDIRP4
CNSTI4 408
ADDP4
...
line 1866
;1862:
;1863:	// set the bit for the reachability area the client is currently in
;1864://	i = trap_AAS_PointReachabilityAreaIndex( ent->client->ps.origin );
;1865://	ent->client->areabits[i >> 3] |= 1 << (i & 7);
;1866:}
LABELV $813
