...
NEI4 $775
line 1565
;1565:		{ //JediDog: Restored damage back to 1.03 //fix'd
line 1567
...
NEI4 $777
line 1568
;1568:			{//G_GetAttackDamage(entity, midamage, maxdamage, multpoint)
line 1569
;1569:				dmg = G_GetAttackDamage(self, 2, 125, 0.5f);
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 2
...
;1573:			{
line 1574
;1574:				dmg = G_GetAttackDamage(self, 2, 210, 0.65f);//fix 200
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 2
...
;1577:			{
line 1578
;1578:				dmg = G_GetAttackDamage(self, 2, 130, 0.5f); //can hit multiple times (and almost always does), so.. fix 120
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 2
...
line 1590
;1590:				dmg = G_GetAttackDamage(self, 2, 100, 0.5f);
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 2
...
;1593:			{
line 1594
;1594:				dmg = G_GetAttackDamage(self, 2, 105, 0.5f); //fix
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 2
...
;1609:			{
line 1610
;1610:				dmg = G_GetAttackDamage(self, 2, 100, 0.5f);
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 2
