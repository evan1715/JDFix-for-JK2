...
pop
line 7039
;7037:	//cm NOTE: I changed this for beta purposes
;7038:	//trap_Cvar_Register(&bot_honorableduelacceptance, "bot_honorableduelacceptance", "0", CVAR_CHEAT);
;7039:	trap_Cvar_Register(&bot_honorableduelacceptance, "bot_honorableduelacceptance", "0", 0);
ADDRGP4 bot_honorableduelacceptance
ARGP4
ADDRGP4 $2956
ARGP4
...
line 7045
;7040:#ifdef _DEBUG
;7041:	trap_Cvar_Register(&bot_nogoals, "bot_nogoals", "0", CVAR_CHEAT);
;7042:	trap_Cvar_Register(&bot_debugmessages, "bot_debugmessages", "0", CVAR_CHEAT);
;7043:#endif
;7044:
;7045:	trap_Cvar_Register(&bot_attachments, "bot_attachments", "1", 0);
ADDRGP4 bot_attachments
ARGP4
ADDRGP4 $2957
ARGP4
...
pop
line 7046
;7046:	trap_Cvar_Register(&bot_camp, "bot_camp", "1", 0);
ADDRGP4 bot_camp
ARGP4
ADDRGP4 $2958
ARGP4
...
line 7048
;7047:
;7048:	trap_Cvar_Register(&bot_wp_info, "bot_wp_info", "1", 0);
ADDRGP4 bot_wp_info
ARGP4
ADDRGP4 $2959
ARGP4
...
pop
line 7049
;7049:	trap_Cvar_Register(&bot_wp_edit, "bot_wp_edit", "0", CVAR_CHEAT);
ADDRGP4 bot_wp_edit
ARGP4
ADDRGP4 $2960
ARGP4
...
pop
line 7050
;7050:	trap_Cvar_Register(&bot_wp_clearweight, "bot_wp_clearweight", "1", 0);
...
pop
line 7051
;7051:	trap_Cvar_Register(&bot_wp_distconnect, "bot_wp_distconnect", "1", 0);
...
pop
line 7052
;7052:	trap_Cvar_Register(&bot_wp_visconnect, "bot_wp_visconnect", "1", 0);
...
line 7054
;7053:
;7054:	trap_Cvar_Update(&bot_forcepowers);
ADDRGP4 bot_forcepowers
ARGP4
ADDRGP4 trap_Cvar_Update
CALLV
...
;7055:	//end rww
;7056:
;7057:	//if the game is restarted for a tournament
;7058:	if (restart) {
ADDRFP4 0
INDIRI4
CNSTI4 0
...
;7060:	}
;7061:
;7062:	//initialize the bot states
;7063:	memset( botstates, 0, sizeof(botstates) );
ADDRGP4 botstates
ARGP4
CNSTI4 0
ARGI4
...
;7076:==============
;7077:*/
;7078:int BotAIShutdown( int restart ) {
line 7083
;7079:
;7080:	int i;
;7081:
;7082:	//if the game is restarted for a tournament
;7083:	if ( restart ) {
ADDRFP4 0
INDIRI4
CNSTI4 0
EQI4 $2969
line 7085
;7084:		//shutdown all the bots in the botlib
;7085:		for (i = 0; i < MAX_CLIENTS; i++) {
ADDRLP4 0
CNSTI4 0
ASGNI4
LABELV $2971
line 7086
;7086:			if (botstates[i] && botstates[i]->inuse) {
ADDRLP4 4
ADDRLP4 0
INDIRI4
CNSTI4 2
...
EQI4 $2975
line 7087
;7087:				BotAIShutdownClient(botstates[i]->client, restart);
ADDRLP4 0
INDIRI4
CNSTI4 2
LSHI4
...
LTI4 $2971
line 7091
;7090:		//don't shutdown the bot library
;7091:	}
ADDRGP4 $2970
JUMPV
LABELV $2969
