...
line 165
;164:
;165:	G_WriteClientSessionData( client );
ADDRFP4 0
INDIRP4
ARGP4
...
;190:/*
;191:==================
;192:G_WriteSessionData
;193:
;194:==================
;195:*/
;196:void G_WriteSessionData( void ) {
line 199
;197:	int		i;
;198:
;199:	trap_Cvar_Set( "session", va("%i", g_gametype.integer) );
ADDRGP4 $123
ARGP4
ADDRGP4 g_gametype+12
INDIRI4
...
line 201
;200:
;201:	for ( i = 0 ; i < level.maxclients ; i++ ) {
ADDRLP4 0
CNSTI4 0
ASGNI4
ADDRGP4 $128
...
LABELV $125
line 202
;202:		if ( level.clients[i].pers.connected == CON_CONNECTED ) {
CNSTI4 2972
ADDRLP4 0
INDIRI4
MULI4
...
NEI4 $130
line 203
;203:			G_WriteClientSessionData( &level.clients[i] );
CNSTI4 2972
ADDRLP4 0
INDIRI4
MULI4
